...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val latitude = 33.596078
        val longitude = 73.013628
        val zoomLevel = 15f
        val homeLanLong = LatLng(latitude, longitude)
        map.moveCamera(CameraUpdateFactory.newLatLngZoom(homeLanLong, zoomLevel))
        map.addMarker(MarkerOptions().position(homeLanLong))
